...
def main():
    ...
    results_log_path = (
        ...
        if args.results_log
        else Path(f"./logs/imoe/moepp/{args.data}/{args.modality}_final_scores.jsonl")
    )
    ...
    if len(seeds) == 1:
        ...
        if args.data == "mosi_regression":
            ...
            run_output = train_and_evaluate_imoe(args, args.seed, fusion_model, "moepp")
        ...
        for seed in seeds:
            ...
            if args.data == "mosi_regression":
                ...
                run_output = train_and_evaluate_imoe(args, seed, fusion_model, "moepp")
                if len(run_output) == 12:
                    (
                        val_acc,
                        val_f1,
